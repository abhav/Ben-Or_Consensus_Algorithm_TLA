...
(* 
 ...
 { variable p1Msg = {}, p2Msg = {}; \* 2 Message boards as told in requirements
   ...
   \* \* node calls this to send p1a msg to other nodes(message board)
   macro SendP1 (n,r,b) 
   {
   ...
   macro CollectP1 (n,r) 
   {
     ...
     \* if received more than n/2 messages with the same v(0/1)
...
=============================================================================
\* Project Completed by Abhav Luthra (50288904) and Krishna Sehgal()
\* Modification History
\* Last modified Wed Nov 27 20:28:30 EST 2019 by abhavluthra
